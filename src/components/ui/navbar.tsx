      ...
      <div className="container-fluid d-flex justify-content-between align-items-center">
        ...
        <ul className="navbar-nav d-flex flex-row">
          {navItems.map((item, index) => (
            ...
            >
              <a
                className="nav-link" // Fix: className should be a string, not a variable
                style={{
                  color: selectedIndex === index ? "#e3c7a0" : "#d5b893", // Highlight selected item
                ...
                onMouseLeave={(e) => (e.currentTarget.style.color = selectedIndex === index ? "#e3c7a0" : "#d5b893")}
                href="#"
              >
                {item}
              </a>
